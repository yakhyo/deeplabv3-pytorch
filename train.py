...
from tools.coco import get_coco
...
def get_transform(train):
    ...
    return utils.SegmentationPresetTrain(base_size, crop_size) if train else utils.SegmentationPresetEval(base_size)
...
def main(args):
    ...
    model = nets.__dict__[args.model](num_classes=num_classes,
...
def get_args_parser(add_help=True):
    ...
    parser.add_argument("--pretrained", dest="pretrained", help="Use pre-trained nets from the modelzoo",
                        action="store_true")
